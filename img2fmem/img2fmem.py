...
# default format widths for output
image_fmt_width = 2
palette_fmt_width = 3
...
if colour_bits == 4:
    pal_size = 16
    image_fmt_width = 1 # 4-bits fit into one hex digit
elif colour_bits == 6:
    pal_size = 64
else:
...
if palette_bits == 24:
    palette_fmt_width = 6  # 24-bits require six hex digits
...
if output_format == 'mem':
    ...
    for d in image_data:
        image_output += "{:0{width}X}\n".format(d, width=image_fmt_width)
...
if output_format == 'mem':
    ...
    for i in range(pal_size):
        ...
        palette_output += "{:0{width}X}\n".format(pal_entry, width=palette_fmt_width)
elif output_format == 'coe':
    palette_output += "; " + MESSAGE
